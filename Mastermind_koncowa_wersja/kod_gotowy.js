window.onload = function() {
    ...
    xp = 10;
    yp = 10;
    bok = 100, xg = 300, yg = 35, pozycja = 0, pomocnik = 0, liczba_k = 4, liczba_w = 8; //liczba_k - liczba kolumn; liczba_w - liczba wierszy
    ...
    function losowanie() // funkcja losujaca sekwencje kolorow do odgadniecia
    {
...
// Rysowanie po lewej kwadratow do wyboru kolorow
    ctx.fillStyle = kolor1;
    ctx.beginPath();
    ctx.fillRect(xp + 25, yp + 55, bok, bok);
    ctx.rect(xp + 25, yp + 55, bok, bok);
    ctx.fillStyle = kolor2;
    ctx.fillRect(xp + bok + 25, yp + 55, bok, bok);
    ctx.rect(xp + bok + 25, yp + 55, bok, bok);
    ctx.fillStyle = kolor3;
    ctx.fillRect(xp + 25, yp + bok + 55, bok, bok);
    ctx.rect(xp + 25, yp + bok + 55, bok, bok);
    ctx.fillStyle = kolor4;
    ctx.fillRect(xp + bok + 25, yp + bok + 55, bok, bok);
    ctx.rect(xp + bok + 25, yp + bok + 55, bok, bok);
    ctx.fillStyle = kolor5;
    ctx.fillRect(xp + 25, yp + 2 * bok + 55, bok, bok);
    ctx.rect(xp + 25, yp + 2 * bok + 55, bok, bok);
    ctx.fillStyle = kolor6;
    ctx.fillRect(xp + bok + 25, yp + 2 * bok + 55, bok, bok);
    ctx.rect(xp + bok + 25, yp + 2 * bok + 55, bok, bok);

    ctx.fillStyle = kolor;
    ctx.fillRect(xp + 25, yp + 3.5 * bok + 55, 2 * bok, 2 * bok);
    ctx.rect(xp + 25, yp + 3.5 * bok + 55, 2 * bok, 2 * bok);
    ...
    function handleClick(e) //funkcja do wybierania kolorow i wstawiania w kwadraciki
    {
...
//Rysowanie planszy
        ...
        function sprawdzaj(pozycja) //funkcja ktora sprawdza czy to poprawny kolor i czy jest na dobrym miejscu
        {
        ...
        document.getElementById("button1").onclick = function() 
        {
            ...
            if (licz == liczba_k) 
            {
                ...
                tak = true;
                if (good == liczba_k) //jesli gracz zgadl wszystkie kolory to wypisuje poprawna sekwencje
                {
                    kolora = kod[0];
                    kolorb = kod[1];
                    kolorc = kod[2];
                ...
                if (good < liczba_k) //jesli gracz doszedl do konca i przegral to wypisuje poprawna sekwencje
                {
        ...
        document.getElementById("button3").onclick = function() //megamind czyli wersja 5 na 12
        {
            liczba_w = 12;
            liczba_k = 5;
            ctx.beginPath();
